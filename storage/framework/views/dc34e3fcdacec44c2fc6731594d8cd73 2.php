...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group required">
                    <input type="text" name="name" class="form-control" placeholder="Name" value="<?php echo e($customer->name); ?>"/>
                  </div>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group required">
                    <input type="text" name="surname" class="form-control" placeholder="Surname" value="<?php echo e($customer->surname); ?>"/>
                  </div>
...
unset($__errorArgs, $__bag); ?>
                  <label for="city" class="control-label">Cognome: </label>
                  <div class="form-group required">
                    <input type="text" name="city" class="form-control" placeholder="City" value="<?php echo e($customer->city); ?>"/>
                  </div>
...
unset($__errorArgs, $__bag); ?>
                  <div class="form-group required">
                    <input type="text" name="username" class="form-control" placeholder="Username" value="<?php echo e($customer->username); ?>" required/>
                  </div>
...
unset($__errorArgs, $__bag); ?>
                  <div class="form-group required">
                    <input type="text" name="email" class="form-control" aria-describedby="emailHelpBlock" placeholder="email" value="<?php echo e($customer->email); ?>" required/>
...
<section id="changepassword">
  <div class="container">
    ...
    <br>
    <form action="<?php echo e(route('customer.passwordupdate', $customer->id )); ?>" method="post">
      <?php echo csrf_field(); ?>
      <?php echo method_field('PUT'); ?>
...
<section>
  <div class="container">
    ...
    <br>
      <a href="<?php echo e(route('customer.deleteaccount', ['id' => $customer->id])); ?>" style="margin-bottom:40px;" class="btn btn-lg btn-danger">Elimina profilo</a>
  </div>
</section>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/EnjoyEat/resources/views/customer/customersettings.blade.php ENDPATH**/ ?>