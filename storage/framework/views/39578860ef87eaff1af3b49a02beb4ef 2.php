...
<?php $__env->startSection('corpo'); ?>
        ...
        <div class="col-md-6">
          <div class="card shadow-sm" style="margin-bottom: 20px;">
            <img src="<?php echo e(asset('img/defaultrestaurant.jpeg')); ?>" alt="Default Restaurant Photo" class="bd-placeholder-img img-fluid" style="object-fit: cover; width: 100%; height: 200px; width:400px;">
              <div class="card-body">
