    ...
    <div class="hero-unit shadow p-3 d-flex" style="justify-content: center; align-items: center; text-align: center;">
                <form method="POST" action="{{ route('owner.createrestaurant', $owner->id) }}" enctype="multipart/form-data">
                  ...
                  <div class="form-floating me-3 required" style="margin-bottom:10px;">
                      <input type="text" name="name" class="form-control rounded-3" id="name" placeholder="Nome" value="" required>
                  </div>
                  @error('email')
                       <div class="text-danger">{{ $message }}</div>
                  @enderror
                  ...
                  <div class="form-floating mb-3 required" style="margin-bottom:10px;">
                    <input type="text" class="form-control rounded-3" id="phonenumber" name="phonenumber" placeholder="Telefono">
                  </div>
                  @error('street')
                       <div class="text-danger">{{ $message }}</div>
                  @enderror
                  <div class="form-floating mb-3 required" style="margin-bottom:10px;">
                    <input type="text" class="form-control rounded-3" id="street" name="street" placeholder="Via">
                  </div>
                  @error('city')
                       <div class="text-danger">{{ $message }}</div>
                  @enderror
                  <div class="form-floating mb-3 required" style="margin-bottom:10px;">
                    <input type="text" class="form-control rounded-3" id="city" name="city" placeholder="Città">
                  </div>
                  @error('postalcode')
                       <div class="text-danger">{{ $message }}</div>
                  @enderror
                  <div class="form-floating mb-3 required" style="margin-bottom:10px;">
                    <input type="text" class="form-control rounded-3" id="postalcode" name="postalcode" placeholder="CAP">
                  </div>
                  @error('country')
                       <div class="text-danger">{{ $message }}</div>
                  @enderror
                  <div class="form-floating mb-3 required" style="margin-bottom:10px;">
                    <input type="text" class="form-control rounded-3" id="country" name="country" placeholder="Stato">
                  </div>
                  @error('description')
                       <div class="text-danger">{{ $message }}</div>
                  @enderror
                  <div class="form-floating mb-3 required" style="margin-bottom:10px;">
                    <textarea class="form-control auto-resize" style="width:100%;" id="description" name="description" placeholder="Descrizione"></textarea>
                  </div>
                  @error('average_price')
                       <div class="text-danger">Seleziona un prezzo medio!</div>
                  @enderror
            ...
            <div class="hero-unit shadow custom-hero2">
                ...
                @csrf
                  @method('PUT')
                    ...
                    @enderror
                    <div class="form-floating me-3 required" style="margin-bottom:10px;">
                      <input type="text" name="name" class="form-control rounded-3" id="name" placeholder="Nome" value="{{ old('name', $restaurant->name) }}">
                    </div>
                    @error('email')
                       <div class="text-danger">{{ $message }}</div>
                    @enderror
                    ...
                    @enderror
                    <div class="form-floating mb-3 required" style="margin-bottom:10px;">
                      <input type="text" class="form-control rounded-3" id="phonenumber" name="phonenumber" placeholder="Telefono" value="{{ old('phonenumber', $restaurant->phonenumber) }}">
                    </div>
                    @error('street')
                       <div class="text-danger">{{ $message }}</div>
                    @enderror
                    <div class="form-floating mb-3 required" style="margin-bottom:10px;">
                      <input type="text" class="form-control rounded-3" id="street" name="street" placeholder="Via" value="{{ old('street', $restaurant->street) }}">
                    </div>
                    @error('city')
                      <div class="text-danger">{{ $message }}</div>
                    @enderror
                      <div class="form-floating mb-3 required" style="margin-bottom:10px;">
                        <input type="text" class="form-control rounded-3" id="city" name="city" placeholder="Città" value="{{ old('city', $restaurant->city) }}">
                      </div>
                    @error('postalcode')
                      <div class="text-danger">{{ $message }}</div>
                    @enderror
                      <div class="form-floating mb-3 required" style="margin-bottom:10px;">
                        <input type="text" class="form-control rounded-3" id="postalcode" name="postalcode" placeholder="CAP" value="{{ old('postalcode', $restaurant->postalcode) }}">
                      </div>
                    @error('country')
                      <div class="text-danger">{{ $message }}</div>
                    @enderror
                    <div class="form-floating mb-3 required" style="margin-bottom:10px;">
                      <input type="text" class="form-control rounded-3" id="country" name="country" placeholder="Stato" value="{{ old('country', $restaurant->country) }}">
                    </div>
                    @error('description')
                      <div class="text-danger">{{ $message }}</div>
                    @enderror
                    <div class="form-floating mb-3 required" style="margin-bottom:10px;">
                      <textarea class="form-control auto-resize" style="width:100%;" id="description" name="description" placeholder="Descrizione">{{ old('description', $restaurant->description) }}</textarea>
                    </div>
                    @error('average_price')
                      <div class="text-danger">{{ $message }}</div>
                    @enderror
