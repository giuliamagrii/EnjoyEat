...
<body style="display: flex; justify-content: center; align-items: center; height: 100vh;">
        <div class="card">
            ...
            <p style="color: black; font-size: 20px;">page not found</p>
            <a class="btn btn-danger" href="<?php echo e(route('home')); ?>">Torna alla home</a>
            </div>
        </div>
    </body>

    </html><?php /**PATH /Applications/MAMP/htdocs/EnjoyEat/resources/views/auth/pageNotFound.blade.php ENDPATH**/ ?>