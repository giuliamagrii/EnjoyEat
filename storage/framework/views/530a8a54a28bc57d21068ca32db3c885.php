...
unset($__errorArgs, $__bag); ?>
                    <div class="form-floating me-3 required" style="margin-bottom:10px;">
                        <input type="text" name="surname" class="form-control rounded-3" id="surname" placeholder="Cognome" value="" required>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                     <div class="form-floating me-3 required" style="margin-bottom:10px;">
                        <input type="text" name="city" class="form-control rounded-3" id="city" placeholder="Città" value="" required>
                    </div>
