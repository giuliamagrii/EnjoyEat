...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group required">
                    <input type="text" name="name" class="form-control" placeholder="Nome" value="<?php echo e($customer->name); ?>"/>
                  </div>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group required">
                    <input type="text" name="surname" class="form-control" placeholder="Cognome" value="<?php echo e($customer->surname); ?>"/>
                  </div>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group required">
                    <input type="text" name="city" class="form-control" placeholder="Città" value="<?php echo e($customer->city); ?>"/>
                  </div>
