...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group required">
                    <input type="text" name="name" class="form-control" placeholder="Name" value="<?php echo e($owner->name); ?>"/>
                  </div>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group required">
                    <input type="text" name="surname" class="form-control" placeholder="Surname" value="<?php echo e($owner->surname); ?>"/>
                  </div>
