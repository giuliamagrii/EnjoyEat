              ...
              <div class="container">
                ...
                <form action="{{ route('owner.update', $owner->id ) }}" method="post">
                  ...
                  <div class="form-group required">
                    <input type="text" name="name" class="form-control" placeholder="Nome" value="{{ $owner->name }}"/>
                  </div>
                  @error('surname')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                  ...
                  <div class="form-group required">
                    <input type="text" name="surname" class="form-control" placeholder="Cognome" value="{{ $owner->surname }}"/>
                  </div>
